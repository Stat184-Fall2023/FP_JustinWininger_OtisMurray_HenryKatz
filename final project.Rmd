...
nflOffense$`Points Per Game` <- round(nflOffense$`Points Per Game`, digits = 2)
nflOffense$`Yards Per Game` <- round(nflOffense$`Yards Per Game`, digits = 2)
nflOffense$`Passing Yards Per Game` <- round(nflOffense$`Passing Yards Per Game`, digits = 2)
nflOffense$`Rushing Yards Per Game` <- round(nflOffense$`Rushing Yards Per Game`, digits = 2)
```
...
gf_point(Points~Yards, data=nflOffense, linewidth=1)%>%gf_lm()
```
...
collegeOffense <- subset(collegeOffense, select=-c(1, 5:7, 9:10, 12:14, 16:25))
...
collegeOffense$`Total Points` <- collegeOffense$Games * collegeOffense$PPG
collegeOffense$`Total Yards` <- collegeOffense$Games * collegeOffense$YPG
